...
class Defaults:
  ...
  def rect_points(pos: list|tuple):
    x_offset = 60
    y_offset = 35
    
    top_left = (pos[X]-x_offset, pos[Y]+y_offset)
    top_right = (pos[X]+x_offset, pos[Y]+y_offset)
    
    bottom_right = (pos[X]+y_offset, pos[Y]-y_offset)
    bottom_left = (pos[X]-y_offset, pos[Y]-y_offset)
    
    return (top_left, top_right, bottom_right, bottom_left)
  
  def rhombus_points(pos:list|tuple):
    offset = 50
  ...
  def oval_points(pos:list|tuple):
    x_offset = 60
    y_offset = 40
    ...
    bottom_right = (pos[X]+x_offset, pos[Y]-y_offset)
    bottom_left = (pos[X]-x_offset, pos[Y]-y_offset)
...
class Action(Object):
    def __init__(self, *args, **kwargs):
        ...
        try:
          ...
          self.shape = Rectangle(Defaults.rect_points(self.pos))
...
class Condition(Object):
    def __init__(self, *args, **kwargs):
        ...
        try: 
          ...
          self.shape = Rhombus(Defaults.rhombus_points(self.pos))
...
class StartStop(Object):
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            self.shape = Oval(Defaults.oval_points(self.pos))
